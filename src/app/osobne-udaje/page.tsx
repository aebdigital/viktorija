    ...
    return (
        <main className="min-h-screen bg-main-bg text-[#1D0E22]">
            ...
            <div className="pt-40 pb-24 w-[95vw] md:w-[60vw] mx-auto min-h-screen font-montserrat font-light text-[#1D0E22]/90 leading-relaxed">
                ...
                <h1 className="font-prociono text-5xl md:text-7xl text-center mb-16 tracking-wide">
                ...
                <div className="space-y-12 text-sm md:text-base">
                    ...
                    {/* Header Info */}
                    <div className="bg-black/5 p-8 rounded-xl border border-[#1D0E22]/10 space-y-2">
                        <p className="font-bold text-[#1D0E22] text-lg mb-4">AEB Digital s. r. o.</p>
                        <p>IČO: 57 307 709</p>
                        <p>Konateľ: Peter Samuel Bobák</p>
                        <p>E-mail: <a href="mailto:peter@aebdig.com" className="text-[#1D0E22] font-semibold hover:underline">peter@aebdig.com</a></p>
                        <p>Tel.: <a href="tel:+421908507131" className="text-[#1D0E22] font-semibold hover:underline">+421 908 507 131</a></p>
                    </div>
                    ...
                    <section className="space-y-4">
                        <h2 className="font-marcellus text-2xl text-[#1D0E22] uppercase tracking-widest border-b border-[#1D0E22]/20 pb-2">I. Kontaktný formulár</h2>
                        ...
                        <ul className="list-disc pl-5 space-y-1 marker:text-[#1D0E22]">
                            <li>Položiť otázku k našim produktom a službám</li>
                            <li>Požiadať o cenovú ponuku</li>
                        </ul>

                        <h3 className="font-bold text-[#1D0E22] mt-4">Rozsah spracúvaných údajov:</h3>
                        <ul className="list-disc pl-5 space-y-1 marker:text-[#1D0E22]">
                        ...
                        <h3 className="font-bold text-[#1D0E22] mt-4">Účel spracovania:</h3>
                        <p>Spracúvame uvedené údaje, aby sme vás mohli kontaktovať a reagovať na váš dopyt.</p>

                        <h3 className="font-bold text-[#1D0E22] mt-4">Právny základ:</h3>
                        <p>Článok 6 ods. 1 písm. b) GDPR – plnenie opatrení pred uzavretím zmluvy na žiadosť dotknutej osoby.</p>

                        <h3 className="font-bold text-[#1D0E22] mt-4">Doba uchovávania:</h3>
                        <p>Osobné údaje budeme uchovávať maximálne 10 rokov od odozvy na váš dopyt, pokiaľ nevznikne ďalší zmluvný vzťah.</p>
                    </section>

                    <section className="space-y-6">
                        <h2 className="font-marcellus text-2xl text-[#1D0E22] uppercase tracking-widest border-b border-[#1D0E22]/20 pb-2">II. Súbory cookies</h2>

                        <div className="space-y-4">
                            <h3 className="font-bold text-[#1D0E22] text-lg">Čo je to Cookie a načo ich používame?</h3>
                        ...
                        <div className="space-y-4">
                            <h3 className="font-bold text-[#1D0E22] text-lg">Aké cookies používame?</h3>
                        ...
                        <div className="space-y-4">
                            <h3 className="font-bold text-[#1D0E22] text-lg">Nastavenie alebo odstránenie Cookies</h3>
                        ...
                        <div className="space-y-4">
                            <h3 className="font-bold text-[#1D0E22] text-lg">Ako zmeniť svoje nastavenie Cookies?</h3>
                        ...
                        <div className="space-y-2">
                            <h4 className="font-bold text-[#1D0E22]/80">Zoznam odkazov na správu cookies v prehliadačoch:</h4>
                            <ul className="list-disc pl-5 space-y-1 marker:text-[#1D0E22] text-sm text-[#1D0E22]/70">
                                <li>
                                    <span className="font-bold text-[#1D0E22]">Internet Explorer</span>:
                                    <a href="http://support.microsoft.com/kb/278835" target="_blank" className="text-[#1D0E22] font-semibold hover:underline ml-1">Desktop verzia</a>
                                    <span className="mx-1">|</span>
                                    <a href="http://comparitech.net/cookies" target="_blank" className="text-[#1D0E22] font-semibold hover:underline">Mobilná verzia</a>
                                </li>
                                <li>
                                    <span className="font-bold text-[#1D0E22]">Chrome</span>:
                                    <a href="http://support.google.com/chrome/bin/answer.py?hl=en-GB&answer=95647" target="_blank" className="text-[#1D0E22] font-semibold hover:underline ml-1">Návod</a>
                                </li>
                                <li>
                                    <span className="font-bold text-[#1D0E22]">Safari</span>:
                                    <a href="http://docs.info.apple.com/article.html?path=Safari/5.0/en/9277.html" target="_blank" className="text-[#1D0E22] font-semibold hover:underline ml-1">Desktop verzia</a>
                                    <span className="mx-1">|</span>
                                    <a href="http://support.apple.com/kb/HT1677" target="_blank" className="text-[#1D0E22] font-semibold hover:underline">Mobilná verzia</a>
                                </li>
                                <li>
                                    <span className="font-bold text-[#1D0E22]">Firefox</span>:
                                    <a href="http://support.mozilla.org/en-US/kb/Enabling%20and%20disabling%20cookies" target="_blank" className="text-[#1D0E22] font-semibold hover:underline ml-1">Návod</a>
                                </li>
                            </ul>
                            <p className="pt-2 text-sm">
                                Z používania vaších cookies sa môžete odhlásiť aj priamo z cookies Google Analytics tu: <a href="http://tools.google.com/dlpage/gaoptout" target="_blank" className="text-[#1D0E22] font-semibold hover:underline">http://tools.google.com/dlpage/gaoptout</a>.
                            </p>
                        </div>

                        <div className="space-y-4">
                            <h3 className="font-bold text-[#1D0E22] text-lg">Zoznam používaných cookies</h3>
                            <p><strong className="text-[#1D0E22]">Google Analytics</strong> – Zhromažďuje súhrn dát o správaní používateľov na webe za účelom skvalitnenia a zlepšenia použiteľnosti webových stránok. Cookies slúžia pre identifikáciu daného užívateľa pomocou náhodného reťazca čísiel, ktorý sa pre daného užívateľa vytvorí pri prvej návšteve.</p>
                            <p><a href="https://developers.google.com/analytics/devguides/collection/analyticsjs/cookie-usage" target="_blank" className="text-[#1D0E22] font-semibold hover:underline break-all">https://developers.google.com/analytics/devguides/collection/analyticsjs/cookie-usage</a></p>
                        </div>

                    </section>

                    <section className="space-y-4">
                        <h2 className="font-marcellus text-2xl text-[#1D0E22] uppercase tracking-widest border-b border-[#1D0E22]/20 pb-2">III. Práva dotknutej osoby</h2>
                        ...
                        <p className="mt-8 pt-8 border-t border-[#1D0E22]/10">
                            V prípade otázok alebo uplatnenia Vašich práv nás môžete kontaktovať na <a href="mailto:reachout@aebdig.com" className="text-[#1D0E22] font-semibold hover:underline">reachout@aebdig.com</a> alebo telefónnom čísle <a href="tel:+421917422245" className="text-[#1D0E22] font-semibold hover:underline">+421 917 422 245</a>.
                        </p>
                        <p className="text-[#1D0E22]/60 text-sm">
